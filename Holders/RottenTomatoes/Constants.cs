...
namespace FlixSharp.Holders.RottenTomatoes
{
    internal static class Constants
    {
        ...
        public const String InTheatersUrl = "http://api.rottentomatoes.com/api/public/v1.0/lists/movies/in_theaters.json?limit={2}&&page={3}&country={1}&apikey={0}";
        ...
        public const String UpcomingMoviesUrl = "http://api.rottentomatoes.com/api/public/v1.0/lists/movies/upcoming.json?limit={2}&&page={3}&country={1}&apikey={0}";
        ...
        public const String CurrentReleaseDVDsUrl = "http://api.rottentomatoes.com/api/public/v1.0/lists/dvds/current_releases.json?limit={2}&&page={3}&country={1}&apikey={0}";
        public const String NewReleaseDVDsUrl = "http://api.rottentomatoes.com/api/public/v1.0/lists/dvds/new_releases.json?limit={2}&&page={3}&country={1}&apikey={0}";
        public const String UpcomingDVDsUrl = "http://api.rottentomatoes.com/api/public/v1.0/lists/dvds/upcoming.json?limit={2}&&page={3}&country={1}&apikey={0}";
